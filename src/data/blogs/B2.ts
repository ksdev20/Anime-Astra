...
export const B2: Blog = {
  ...
  imageUrl:
    "https://ik.imagekit.io/nwstforna/AnimeAstra/Blog2/top-5-anime-with-mind-games-that-rival-death-note-cover.jpg",
  subTitle:
    "Spoiler-free guides to five anime that match Death Note’s brilliance in psychological warfare and strategic tension",
  author: "Kiseki",
  date: "03/10/2025",
  ...
  readMinutes: 11,
  toc: [
    { text: "Code Geass", link: "#code-geass" },
    { text: "Kaiji", link: "#kaiji" },
    { text: "Monster", link: "#monster" },
    { text: "Tomodachi Game", link: "#tomodachi-game" },
    { text: "One Outs", link: "#one-outs" },
  ...
  animeObjects: [
    {
      ...
      img: "https://ik.imagekit.io/nwstforna/AnimeAstra/Blog2/code-geass.webp",
      link: "https://anikawa.vercel.app/show/ygAJ0by-NqxVFD_/code-geass-lelouch-of-the-rebellion",
      ratings: {
        imdb: {
      ...
      pg: [
        {
          imdb: "Moderate",
          message: "Violence, war themes, and moral ambiguity",
        },
      ],
      bigText: [
        {
    ...
    },
    {
      ...
      title: {
        ...
        romaji: "Gyakkyo Burai Kaiji: Ultimate Survivor",
      },
      img: "https://ik.imagekit.io/nwstforna/AnimeAstra/Blog2/kaiji.webp",
      link: "https://www.primevideo.com/detail/0QXN3XS7B6HWVKANPB67UW51AN/ref=atv_dp_share_cu_r",
      ratings: {
        imdb: {
          link: "https://www.imdb.com/title/tt1202625/",
          rating: "",
        },
        mal: {
          link: "https://myanimelist.net/anime/3002/Gyakkyou_Burai_Kaiji__Ultimate_Survivor",
          rating: "",
        },
      },
      seasonMetrics: {
      ...
      streaming: [
        {
          platform: "Netflix",
          link: "https://www.netflix.com/in/title/81409812",
          message: "paid",
        },
        {
      ...
      pg: [
        {
          imdb: "Moderate",
          message: "High-stress situations, gambling, and desperation",
        },
      ],
      bigText: [
        {
    ...
    },
    {
      ...
      img: "https://ik.imagekit.io/nwstforna/AnimeAstra/Blog2/monster.webp",
      link: "https://www.netflix.com/in/title/81409869",
      ratings: {
        imdb: {
          link: "https://www.imdb.com/title/tt0434706/",
          rating: "",
        },
        mal: {
      ...
      pg: [
        {
          imdb: "High",
          message: "Mature themes, violence, and psychological horror",
        },
      ],
      bigText: [
        {
    ...
    },
    {
      ...
      img: "https://ik.imagekit.io/nwstforna/AnimeAstra/Blog2/tomodachi-game.webp",
      link: "https://www.primevideo.com/detail/0THIAL4P9P694OFR0Z1HSFAKIV/ref=atv_dp_share_cu_r",
      ratings: {
        imdb: {
          link: "https://www.imdb.com/title/tt15830678/",
          rating: "",
        },
        mal: {
      ...
      pg: [
        {
          imdb: "Moderate",
          message: "Manipulation, betrayal, and emotional stress",
        },
      ],
      bigText: [
        {
    ...
    },
    {
      ...
      img: "https://ik.imagekit.io/nwstforna/AnimeAstra/Blog2/one-outs.webp",
      link: "https://www.hulu.jp/watch/100003288",
      ratings: {
        imdb: {
          link: "https://www.imdb.com/title/tt1411815/",
          rating: "",
        },
        mal: {
      ...
      pg: [
        {
          imdb: "Mild",
          message: "Mind games and manipulation in a sports setting",
        },
      ],
      bigText: [
        {
